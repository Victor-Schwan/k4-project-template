...
private:
  ...
  //  // Helper to find a TrackState with a specific location ID
  //  std::optional<edm4hep::TrackState> getTrackStateByLocation(const edm4hep::Track& track, int location) const {
